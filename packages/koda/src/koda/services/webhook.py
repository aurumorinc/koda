...
from ..config import WebhookConfig, ScrapeResponse

__all__ = ["WebhookService"]

class WebhookService:
    """Service responsible for dispatching webhook callbacks."""

    @classmethod
    async def dispatch(cls, config: WebhookConfig, response: ScrapeResponse) -> None:
        """
